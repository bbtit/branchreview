...
|   10a | [#14 MVP-10a](https://github.com/bbtit/sidediff/issues/14) Git context cache | タブ切替の git 連打を削減      |
|   10b | [#15 MVP-10b](https://github.com/bbtit/sidediff/issues/15) Dirty check       | status の積み上がり・lock      |
|   10c | [#16 MVP-10c](https://github.com/bbtit/sidediff/issues/16) Large PR          | 大きな diff で黙って失敗しない |
