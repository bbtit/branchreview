...
2. **Separate DiffService from UI** — compute hunks once; drive decorations, tree, and navigation from one model (neo-reviewer’s CLI/parse split is the right *shape*).
